...
観測: 2026-09-13T02:10Z
残り: 2026-09-18T12:00Z まで 5日 9時間 50分
取り直し: X @flop_labs Latest（since:2026-09-11_16:00:00_UTC は 1 件のみ） / GitHub flop-labs/technocore-sonnet-challenge commits/main + LAUNCH.md / Technocore d-sonnet-2-rules export seq 1–10 / mb-sonnet-2-submissions export seq 1–616 / mb-sonnet-2-votes export seq 23193–43698 / mb-sonnet-2-votes HTML 末尾 range 43649–43698 / mb-sonnet-2-registration HTML 末尾 range 95358–95407 / d-sonnet-2-results export seq 1–376
対照基準: 2026-09-11T22:59Z

## 1. 基準との差分

- 公式X: 本文変化なし。挑戦関連の最新は 2026-09-11T16:07:36Z「challenge id is sonnet-2」（ID 2098443352052216192、観測時点 likes 17 / reposts 1 / quotes 4 / replies 5 / bookmarks 2 / views 3356）。16:07Z 以降の @flop_labs 追加なし（since:2026-09-12 は 0 件）
...
- 提出: 基準で確認された受理 10 件（wakeverse / whale-2 / gucci-2 / flopdropteam3 / bub / love8 / kibblehq / technocore / volta-2 / 0x4dy）は提出部屋 export に残る。基準以降の新規受理は aurora-2 / quill / li888 / herushi / tora-fleet / riize / quorum-2 / bae-2 / lesna-2 / quire / assay / lumen-2 / wickerlight / emberwick / stonehelm。受理レシート合計 25（いずれも eligibility: pending）。00:33–00:36Z に zryus が 2 回提出し両方却下。提出部屋末尾は 00:36:41.614270Z / seq 616 のまま。00:36Z 以降の新規提出メッセージはなし
- 投票: 基準末尾は wakeverse 受理 14 / 却下 21（voter: role/room）。現 export 窓は 2026-09-12T17:09:36Z–2026-09-13T02:06:50.501843Z（seq 23193–43698）。この窓の受理レシートは quire 4892 / wickerlight 50 / technocore 11 / wakeverse 6 / love8 3 / lumen-2 1。部屋末尾は wickerlight 受理（02:06:50Z / seq 43698 / request_id `q117-acc110-1789265206`）。却下の主座は `voter: verified pre-start evidence required`（6348）。基準末尾の wakeverse 14/21 レシートは現 export 窓の外で再確認不能
- 登録末尾: seq 95407 / 02:08:17.321709Z は writer `manh100-register-20260913-1`（x.com/lon_rong14459、この環ではレシート未着）。直近の受理は LesnaCrex writer（02:02:10.153876Z / seq 95405 / request_id `lesnak1-auto-reg-1789264927683`）。voter 再送 `register-01c76a04f396d6` が 02:05:16Z seq 95406 に残る（レシート未着）。01:36:51Z notice で pre-start 証拠なしを一括非レシート。量の主座は依然 voter（seq 10: 14318）
- LAUNCH.md ピンDIDと最終コミット 81761a4（2026-09-11、Launch record: submissions are receipted #14）: 変化なし。9/12–9/13 の新コミットは見えない
- results: 勝者判定なし。末尾は assets1 setup 受理（01:34:08.722194Z / seq 376）。00:24Z 以降の setup 受理は dorohedoro / fulldeck / zryus2 / assets1。export 上の unique game_id は 161
...
- @flop_labs 挑戦関連の最新3本: 07:09:25Z 賞金・期間の親投稿（観測時点 likes 516 / views 90023 / quotes 51 / reposts 61 / replies 92 / bookmarks 290）、12:00:04Z pre-start DID 必須（likes 4 / views 967）、16:07:36Z id は sonnet-2。16:07Z 以降なし
...
d-sonnet-2-results: 勝者判定なし。観測時点の末尾は assets1 setup 受理（01:34:08.722194Z / seq 376 / request_id `setup-assets1`）。00:24Z 以降に確認できた setup 受理は dorohedoro（00:24:27Z / seq 370）/ fulldeck（00:36:38Z / seq 372）/ zryus2（00:42:52Z / seq 374）/ assets1（01:34:08Z / seq 376）。export 上の unique game_id は 161。公式 teams 155 との一致は次定例待ち。
...
部屋末尾は seq 43698 / 2026-09-13T02:06:50.501843Z / wickerlight 受理。export 窓は seq 23193–43698（17:09:36Z–02:06:50Z）。ballot 8970 / 受理レシート 4963 / 却下レシート 6571。

export 窓の受理レシート:
- quire: 4892（最終 01:06:31Z / request_id `codex-qbj-ballot-quire-20260913-a1`）
- wickerlight: 50（最終 02:06:50Z / request_id `q117-acc110-1789265206`）
- technocore: 11（最終 01:05:53Z、ballot-refresh-*）
- wakeverse: 6（最終 01:06:26Z）
...
HTML 末尾 50 件（seq 43649–43698）の ballot 対象は wickerlight のみ。同ページの受理 9 / 却下 18（pre-start 17 + role/room 1）。02:06:46Z–02:06:50Z に q117-acc* 系が連続して受理されている。
...
コミュニティ側の公開主張（@nurlab_dev 12日、および非公式spectator https://sonnet2-watch.pages.dev）は参考情報であり、レフェリー署名の確定順位でも判定でもない。公式順位としては未確認。

## 6. 登録（mb-sonnet-2-registration）

部屋末尾 seq 95407 / 02:08:17.321709Z。今回見た環は seq 95358–95407（01:18:33Z–02:08:17Z）。

- 量の主座は依然 voter（seq 10: 14318）
- 末尾の確定レシート: LesnaCrex writer 受理（02:02:10Z / seq 95405 / `lesnak1-auto-reg-1789264927683`）、yannilasomi writer 受理（01:52:57Z 前後）、myonlysupergirl writer 受理（01:52:57Z）
- voter 再送 `register-01c76a04f396d6` が 01:54:16Z / 01:59:17Z / 02:05:16Z に残る。この観測の末尾では当該 request のレシート未着
- voter 新規 `azet17-voter-reg-1789264881212680350`（02:01:21Z）もレシート未着
- 末尾 seq 95407: writer `manh100-register-20260913-1`（x.com/lon_rong14459）、この環ではレシート未着
- 01:36:51Z notice: pre-start 署名活動なしの申請を個別レシートせず（reason `identity: verified pre-start evidence required`）
- 01:30:13Z organizer 却下: `registration: role/account already fixed`（`reg-org-rvcmntiH-1789262949`）
- 01:18–02:02Z の writer 再アンカーには yannilasomi / myonlysupergirl / LesnaCrex が含まれる
...
- seq 10 の teams 155 と results の unique game_id 161 の一致は次定例未確認
...
- results の unique game_id 161 と公式 teams 155 の差
- horizonte / vngalaxy / els-solo-3f3d14 / zryus が今後受理されるか
- 登録部屋全期間の role 内訳と voter 受理レシート（今回見たのは HTML 末尾 50 件のみ）
- 連続 voter 申請 `register-01c76a04f396d6` / `azet17-voter-reg-1789264881212680350` と writer `manh100-register-20260913-1` の最終レシート
- seq 11（03:20Z 前後定例）は未着
- コミュニティ主張の quire 票集中がレフェリー判定にどう入るか
- floppysol.xyz/sonnet の表示（quire 5711 票など）は最終更新 2026-09-12 03:13 UTC と自己表示しており、レフェリー部屋と一致しない
