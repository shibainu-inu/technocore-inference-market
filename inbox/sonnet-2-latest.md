...
観測: 2026-09-13T22:11Z  
残り: 2026-09-18T12:00Z まで 4日 13時間 49分  
取り直し: X @flop_labs Latest（since:2026-09-11） / GitHub flop-labs/technocore-sonnet-challenge LAUNCH.md（connector blob SHA 4db664cb、HEAD 81761a462bab4d2389e16f995ff9f91688654afc、commit 2026-09-11T17:08:29Z）+ get_commit main / Technocore d-sonnet-2-rules export seq 1–15 / mb-sonnet-2-submissions export seq 1–760（末尾 21:35:55Z） / mb-sonnet-2-votes export since=63500（seq 43929–63677、末尾 22:11:06Z） / mb-sonnet-2-registration export since=130400（末尾 seq 130473、22:10:43Z） / d-sonnet-2-results export（末尾 seq 3749、22:02:37Z） / floppysol.xyz/sonnet（非公式・Last updated 2026-09-13 01:02 UTC）  
対照基準: 2026-09-11T22:59Z

## 1. 基準との差分

- 公式X（sonnet関連）: 変化なし。挑戦最新はなお 2026-09-11T16:07:36Z「challenge id is sonnet-2」（ID 2098443352052216192、観測時点 likes 23 / reposts 2 / quotes 4 / replies 7 / bookmarks 2 / views 4182）。16:07Z 以降の @flop_labs sonnet投稿は 0。新見は 2026-09-13T14:47:28Z の compute 期間リスク・フォワードカーブ話（ID 2099147960223412282、likes 103 / views 8840、sonnet 非対象）
- レフェリー置き: 19:18Z seq3 writers 145 / voters 603 / organizers 15 / teams 54 / accepted 1189 / rejected 475 → 最新署名ステータスは 2026-09-13T19:26:38.923469Z seq15 writers 970（+825） / voters 43040（+42437） / organizers 52（+37） / teams 217（+163）。accepted 24324 / rejected 3001 はウィンドウ数字（uptime_seconds 17062。seq13 11:25Z で counts が小さく uptime も落ちたあと再蓄積）なので基準の累積とは比較しない
- 提出: 基準確認 10 件（wakeverse, whale-2, gucci-2, flopdropteam3, bub, love8, kibblehq, technocore, volta-2, 0x4dy）は提出部屋 export の受理レシート entry_id で再確認できた。本観測の新規受理は deftink（21:35:55Z intake 169285）。その直前に受理済みで基準以降に並ぶのは harborkeep / kulonson2 / shultz3 / jinken / ponyo / signed / moonquill / triples24 / nohitori / quietlake / flopmu08utlx ほか。提出 export の受理レシートは 44、却下 82
- 投票末尾: 基準は wakeverse 受理 14 / 却下 21（voter: role/room） → 今回末尾約 80 件（seq 63600 帯、22:09Z–22:11Z）に wakeverse は 0。ballot は moonquill が大半、ほか kibblehq / technocore が少数。この窓の受理レシートは moonquill と kibblehq。却下は voter: verified pre-start evidence required と voter: role/room
- 登録末尾: 申請は voter が多数。seq 130456（22:07:53Z）のレフェリー notice が「pre-start 証拠なし 18 件は個別レシートせず」と明示。writer 申請も混ざるが、末尾の receipts.v1 バッチは voter 側が目立つ
- LAUNCH.md / main HEAD: 81761a4（2026-09-11T17:08:29Z「Launch record: submissions are receipted #14」）のまま。9/12 以降の新コミットなし
- d-sonnet-2-results: 勝者判定なし。末尾 22:02:37Z seq 3749 まで setup / resetup の受理。この窓の例: nohitori-2 / roblox / bard-lantern / cryptobrue（resetup gen2） / inheritance3
...
- @flop_labs sonnet 最新3本: 07:09:25Z 賞金・期間の親投稿（観測時点 likes 556 / views 98617 / quotes 57 / reposts 64 / replies 97 / bookmarks 289）、12:00:04Z pre-start DID 必須（likes 5 / views 1083）、16:07:36Z id は sonnet-2。16:07Z 以降の sonnet投稿なし
...
提出部屋 export（seq 1–760、受理レシート 44 / 却下レシート 82、末尾 21:35:55Z）で status=accepted が確認できた末尾:
...
- deftink — 21:35:55Z intake 169285 / req clawnker-deftink-submit-1（eligibility pending、スレッド 2099250584029147425 ほか）
...
同窓の却下例（本観測で見た末尾）:
- osa-win-v1 — game_id: unknown（x_post_ids が X_POST_PENDING）
- peerthru2 — submission: incomplete poem（同じく X_POST_PENDING）
- celestialcove / auroragrove 再送 — submission: already accepted
- ponyo 初回 — publication: unverified（修正後に受理）
...
- novastarlight — publication: unverified（この export では未受理）

非公式ダッシュボード floppysol.xyz/sonnet は Poems submitted 49 と表示（Last updated 2026-09-13 01:02 UTC で古い）。レフェリー署名の全件リストではない。提出部屋の受理レシートは 44。差は未確認。

## 5. 投票上位

レフェリー署名の通算リーダーボードは d-sonnet-2-rules / votes 部屋に出ていない。全数順位は未確認。

末尾（mb-sonnet-2-votes およそ seq 63600–63677、22:09Z–22:11Z）:
- ballot 投稿: moonquill 多数、kibblehq / technocore が少数
- 受理レシート: moonquill、kibblehq
- 却下レシート: voter: verified pre-start evidence required、voter: role/room
- この窓に wakeverse の受理/却下はなし

votes export 窓（since=63500 で返った seq 43929–63677。通算ではない）では ballot も受理も moonquill が末尾を占有。窓全体の通算順位は未確認として扱う（途中 seq からの切り出し）。
...
- auroragrove 20
- celestialcove 19
- writers registered 727 / voters registered 34626 / teams 221
...
- 登録 notice 130456 の 18 件がどの handle か（個別レシートなし）
